...
Run 2026-07-20 with bigo 1.33.1.

**Aggregate: 30.4%** — 10194 of 33504 first-party functions bounded.

## Per target

| Target | Module | Commit | Functions | Bounded | Coverage |
|---|---|---|---|---|---|
| grpc-go | google.golang.org/grpc | 2fd426d0 | 5467 | 1818 | 33.3% |
| caddy | github.com/caddyserver/caddy/v2 | 0e8eb41b | 1963 | 446 | 22.7% |
| prometheus | github.com/prometheus/prometheus | a0524eeca | 5859 | 1809 | 30.9% |
| etcd | go.etcd.io/etcd/v3 | 22b4192b9 | 98 | 9 | 9.2% |
| delve | github.com/go-delve/delve | 8fc4acbd | 2793 | 669 | 24.0% |
| chi | github.com/go-chi/chi/v5 | 3b17157 | 180 | 58 | 32.2% |
| goldmark | github.com/yuin/goldmark | 50ba9fc | 795 | 441 | 55.5% |
| pgx | github.com/jackc/pgx/v5 | 0a977a6 | 2099 | 701 | 33.4% |
| cel-go | github.com/google/cel-go | 646511d | 3586 | 1482 | 41.3% |
| expr | github.com/expr-lang/expr | 4b31df3 | 1286 | 217 | 16.9% |
| nats-server | github.com/nats-io/nats-server/v2 | 2e5f51f31 | 4000 | 856 | 21.4% |
| hugo | github.com/gohugoio/hugo | 89b8c3220 | 5378 | 1688 | 31.4% |
...
| unresolved cost at call to errors.New | 1193 |
| unresolved cost at call to (interface).Helper | 573 |
| unresolved cost at call to time.Now | 537 |
...
| unresolved cost at call to reflect.ValueOf | 365 |
...
| unresolved cost at call to (reflect.Value).Type | 285 |
...
| unresolved cost at call to strconv.Itoa | 249 |
| unresolved cost at call to (reflect.Value).Kind | 244 |
